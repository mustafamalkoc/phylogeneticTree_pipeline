...
include: "workflows/rules/mafft.smk"
...
rule all:
    input:
        ...
        expand("results/{protein}/msa/{protein}_mafft_einsi.fasta", protein=config["proteins"]),
        expand("results/{protein}/iqtree/{protein}_mafft_einsi_mid_lineage.nwk", protein=config["proteins"]),
        expand("results/{protein}/iqtree/{protein}_mafft_einsi_mid_lineage_dup.nwk", protein=config["proteins"]),
        ...
        expand("results/{protein}/figures/{protein}_combinedTreeFigure.png", protein=config["proteins"]),
