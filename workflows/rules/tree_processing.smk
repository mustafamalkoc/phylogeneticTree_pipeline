rule midpoint_rooting:
    ...
    output:
        rootedTree=report("results/{protein}/iqtree/{protein}_mafft_einsi_mid.nwk", category="{protein}", subcategory="Tree Files"),
    resources:
...
rule add_lineage:
    ...
    output:
        lineageAddedTree = "results/{protein}/iqtree/{protein}_mafft_einsi_mid_lineage.nwk",
    resources:
        protein_name = lambda wildcards: wildcards.protein
    log:
...
rule label_dup_nodes:
    ...
    output:
        tree_midLineageDup=report("results/{protein}/iqtree/{protein}_mafft_einsi_mid_lineage_dup.nwk", category="{protein}", subcategory="Tree Files"),
    resources:
        protein_name = lambda wildcards: wildcards.protein
    log:
